...
| Backend | Source | Newest-tag stop marker |

| --- | --- | --- | --- |

| KoboldCpp | https://github.com/LostRuins/koboldcpp/releases | `v1.117.1` |

| stable-diffusion.cpp  https://github.com/leejet/stable-diffusion.cpp/releases | `master-775-b5d8120` |

| llama.cpp |  https://github.com/ggml-org/llama.cpp/releases | `b9986` |
