...
var optionCatalog = enrichOptionCatalog([]OptionDefinition{
	...
	option("load_mode", "Load Mode", LaneText, ValueString, "", false, "llama_sdcpp"),
	option("reasoning_preserve", "Reasoning Preserve", LaneText, ValueString, "--reasoning-preserve", false, "llama_sdcpp"),
	...
	option("draft_dflash", "Draft DFlash", LaneText, ValueBool, "--draft-dflash", false, "llama_sdcpp"),
	option("draft_dspark", "Draft DSpark", LaneText, ValueBool, "--draft-dspark", false, "llama_sdcpp"),
	...
	option("sdstreamlayers", "Stream Layers", LaneImage, ValueBool, "--stream-layers", false, "llama_sdcpp"),
