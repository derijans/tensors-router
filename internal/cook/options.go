...
var optionCatalog = enrichOptionCatalog([]OptionDefinition{
	...
	option("routermode", "Router Mode", LaneRuntime, ValueBool, "", false, "kobold"),
	...
	option("ssl", "SSL", LaneRuntime, ValueJSON, "", false, "kobold"),
	...
	option("multiuser", "Multi User", LaneRuntime, ValueNumber, "", false, "kobold", "llama_sdcpp"),
	...
	option("mcp_enabled", "Enable MCP", LaneRuntime, ValueBool, "", false, "kobold", "llama_sdcpp"),
	option("mcp_servers", "MCP Servers", LaneRuntime, ValueJSON, "", false, "kobold", "llama_sdcpp"),
	...
	option("debugmode", "Debug Mode", LaneRuntime, ValueNumber, "", false, "kobold"),
	...
	option("kv_unified_per_slot", "Unified KV Per Slot", LaneText, ValueNumber, "--kv-unified-per-slot", false, "llama_sdcpp"),
	...
	option("usecuda", "Use CUDA", LaneText, ValueJSON, "", false, "kobold"),
	option("usecublas", "Use cuBLAS", LaneText, ValueBool, "", true, "kobold"),
	option("usevulkan", "Use Vulkan", LaneText, ValueJSON, "", false, "kobold"),
	...
	option("smartcache", "Smart Cache", LaneText, ValueNumber, "", false, "kobold"),
	...
	option("moecpu", "MoE CPU", LaneText, ValueNumber, "", false, "kobold"),
	option("ffncpu", "FFN CPU", LaneText, ValueNumber, "", false, "kobold"),
	option("n_cpu_ffn", "CPU FFN Layers", LaneText, ValueNumber, "--n-cpu-ffn", false, "llama_sdcpp"),
	...
	option("loramult", "LoRA Multiplier", LaneText, ValueNumber, "", false, "kobold"),
	option("draftmodel", "Draft Model", LaneText, ValueString, "--model-draft", false, "kobold", "llama_sdcpp"),
	...
	option("mmproj_device", "Projector Device", LaneMultimodal, ValueString, "--mmproj-device", false, "llama_sdcpp"),
	...
	option("reasoning_effort", "Reasoning Effort", LaneText, ValueString, "--reasoning-effort", false, "llama_sdcpp"),
	option("tools_runtime", "Tools Runtime", LaneRuntime, ValueString, "--tools-runtime", false, "llama_sdcpp"),
	...
	option("sdllmvision", "Image LLM Vision", LaneImage, ValueString, "--llm_vision", false, "llama_sdcpp"),
	option("sdtokenizer", "Image Tokenizer", LaneImage, ValueString, "--tokenizer", false, "llama_sdcpp"),
	option("sdclipvision", "CLIP Vision", LaneImage, ValueString, "--clip_vision", false, "llama_sdcpp"),
	option("sdipadapter", "IP Adapter", LaneImage, ValueString, "--ip-adapter", false, "llama_sdcpp"),
	option("sdmotionmodule", "Motion Module", LaneImage, ValueString, "--motion-module", false, "llama_sdcpp"),
	option("sdembeddingsconnectors", "Embedding Connectors", LaneImage, ValueJSON, "--embeddings-connectors", false, "llama_sdcpp"),
	...
	option("sdaudiovae", "Audio VAE", LaneImage, ValueString, "--audio-vae", false, "kobold", "llama_sdcpp"),
	option("sdaudioencoder", "Audio Encoder", LaneImage, ValueString, "--audio-encoder", false, "llama_sdcpp"),
	...
	option("sdphotomaker", "PhotoMaker", LaneImage, ValueString, "--photo-maker", false, "kobold", "llama_sdcpp"),
	...
	option("sdhiresupscalersdir", "Hires Upscalers Directory", LaneImage, ValueString, "--hires-upscalers-dir", false, "llama_sdcpp"),
	option("sdloramult", "Image LoRA Multiplier", LaneImage, ValueJSON, "", false, "kobold"),
	option("sdquant", "Image Quant", LaneImage, ValueNumber, "--sdquant", false, "kobold"),
	...
	option("sdsageattention", "SageAttention", LaneImage, ValueBool, "--sage-attn", false, "llama_sdcpp"),
	option("sdlinearscale", "Linear Scale", LaneImage, ValueNumber, "--linear-scale", false, "llama_sdcpp"),
	option("sdattnscale", "Attention Scale", LaneImage, ValueNumber, "--attn-scale", false, "llama_sdcpp"),
	...
	option("sdclamped", "SD Clamped", LaneImage, ValueNumber, "", false, "kobold"),
	option("sdclampedsoft", "SD Soft Clamp", LaneImage, ValueNumber, "", false, "kobold"),
	...
	option("sdstreamlayers", "Stream Layers", LaneImage, ValueBool, "", false, "llama_sdcpp"),
	option("sdstreaming", "Streaming", LaneImage, ValueBool, "", false, "llama_sdcpp"),
	option("sdautofit", "Image Auto Fit", LaneImage, ValueBool, "--auto-fit", false, "llama_sdcpp"),
	option("sdconditioningcachesize", "Conditioning Cache Size", LaneImage, ValueNumber, "--conditioning-cache-size", false, "llama_sdcpp"),
	option("sddisableprefetch", "Disable Prefetch", LaneImage, ValueBool, "--disable-prefetch", false, "llama_sdcpp"),
	option("sddisablesegmentedcompute", "Disable Segmented Compute", LaneImage, ValueBool, "--disable-segmented-compute", false, "llama_sdcpp"),
	option("sdloglevel", "Image Log Level", LaneImage, ValueString, "--log-level", false, "llama_sdcpp"),
	option("sdmodelargs", "Image Model Args", LaneImage, ValueString, "--model-args", false, "llama_sdcpp"),
	option("sdextrasampleargs", "Extra Sample Args", LaneImage, ValueString, "--extra-sample-args", false, "llama_sdcpp"),
	option("sdextratilingargs", "Extra Tiling Args", LaneImage, ValueString, "--extra-tiling-args", false, "llama_sdcpp"),
	option("sdimagepreprocess", "Image Preprocess Rules", LaneImage, ValueJSON, "--image-preprocess", false, "llama_sdcpp"),
	...
	option("sdcircularx", "Circular Padding X", LaneImage, ValueBool, "--circularx", false, "llama_sdcpp"),
	option("sdcirculary", "Circular Padding Y", LaneImage, ValueBool, "--circulary", false, "llama_sdcpp"),
	...
	option("sampler_rng", "Sampler RNG", LaneImage, ValueString, "--sampler-rng", false, "llama_sdcpp"),
	...
	option("whispercpp_no_context", "Whisper Disable Previous Context", LaneVoice, ValueBool, "", false, "llama_sdcpp"),
...
var optionMetadataByKey = map[string]optionMetadata{
	...
	"gpulayers":                  meta(values("-1", "0", "99"), "", "-1", SourceLlamaCPPServer, ""),
	"splitmode":                  meta(values("none", "layer", "row", "tensor"), "", "layer", SourceLlamaCPPServer, ""),
	"tensor_split":               meta(nil, "", "", SourceLlamaCPPServer, ""),
	"maingpu":                    meta(nil, "", "-1", SourceKoboldCPP, ""),
	"usemmap":                    meta(boolChoices(), "", "true", SourceLlamaCPPServer, ""),
	"usemlock":                   meta(boolChoices(), "", "false", SourceLlamaCPPServer, ""),
	"usedirectio":                meta(boolChoices(), "", "", SourceKoboldCPP, ""),
	"load_mode":                  meta(catalog.LlamaLoadModes(), "", "auto", SourceLlamaCPPServer, ""),
	"lazy_mode":                  meta(values("on", "auto", "off"), "", "auto", SourceLlamaCPPServer, ""),
	"reasoning_preserve":         meta(boolChoices(), "", "true", SourceLlamaCPPServer, ""),
	"reasoning_effort":           meta(values("default", "minimal", "low", "medium", "high", "xhigh", "max"), "", "default", SourceLlamaCPPServer, ""),
	"n_cpu_ffn":                  meta(nil, "", "0", SourceLlamaCPPServer, ""),
	"kv_unified_per_slot":        meta(nil, "", "", SourceLlamaCPPServer, ""),
	"video_fps":                  meta(values("1", "2", "4", "8"), "", "4", SourceLlamaCPPServer, SectionEmbed),
	"video_timestamp_interval":   meta(values("1000", "5000", "10000"), "", "5000", SourceLlamaCPPServer, SectionEmbed),
	...
	"usecuda":                    meta(nil, "", "", SourceKoboldCPP, ""),
	"usecublas":                  meta(boolChoices(), "", "", SourceKoboldCPP, ""),
	"usevulkan":                  meta(nil, "", "", SourceKoboldCPP, ""),
	...
	"run_embed_separate":         meta(boolChoices(), "", "false", "", SectionEmbed),
	...
	"type":                       meta(values("f32", "f16", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "q2_0", "q2_K", "q3_K", "q4_K", "f8_e4m3", "f8_e5m2"), "", "", SourceStableDiffusionCPP, ""),
	...
	"prediction":                 meta(values("eps", "v", "edm_v", "sd3_flow", "flux_flow", "sefi_flow", "minit2i_flow", "sensenova_u1_flow"), "", "", SourceStableDiffusionCPP, ""),
	...
	"cache_option":               meta(nil, "", "", SourceStableDiffusionCPP, ""),
	"whispermodel":               meta(nil, "voice", "", SourceKoboldCPP, ""),
	"whispercpp_no_context":      legacyMeta(boolChoices(), "", "", SourceWhisperCPPServer, ""),
	...
	"debugmode":                  meta(values("-1", "0", "1"), "", "0", SourceKoboldCPP, ""),
	...
	"reasoningeffort":            meta(values("default", "none", "low", "medium", "high", "xhigh"), "", "default", SourceKoboldCPP, ""),
	...
	"smartcache":                 meta(nil, "", "0", SourceKoboldCPP, ""),
	...
	"moecpu":                     meta(nil, "", "0", SourceKoboldCPP, ""),
	"ffncpu":                     meta(nil, "", "0", SourceKoboldCPP, ""),
	"moeexperts":                 meta(values("0", "1", "2", "4", "8", "16"), "", "", SourceKoboldCPP, ""),
	"nobostoken":                 meta(boolChoices(), "", "", SourceKoboldCPP, ""),
	"spec_type":                  meta(values("none", "draft-simple", "draft-eagle3", "draft-mtp", "draft-dflash", "draft-dspark", "ngram-simple", "ngram-map-k", "ngram-map-k4v", "ngram-mod", "ngram-cache"), "", "none", SourceLlamaCPPServer, ""),
	...
	"sdtokenizer":                meta(nil, "tokenizer", "", SourceStableDiffusionCPP, ""),
	"sdaudioencoder":             meta(nil, "audio_encoder", "", SourceStableDiffusionCPP, ""),
	"sdclipvision":               meta(nil, "clip", "", SourceStableDiffusionCPP, ""),
	"sdipadapter":                meta(nil, "ip_adapter", "", SourceStableDiffusionCPP, ""),
	"sdmotionmodule":             meta(nil, "motion", "", SourceStableDiffusionCPP, ""),
	...
	"sdclamped":                  meta(nil, "", "0", SourceKoboldCPP, ""),
	"sdclampedsoft":              meta(nil, "", "0", SourceKoboldCPP, ""),
	...
	"sdstreamlayers":             legacyMeta(boolChoices(), "", "", SourceStableDiffusionCPP, ""),
	"sdstreaming":                legacyMeta(boolChoices(), "", "", SourceStableDiffusionCPP, ""),
	"sdautofit":                  meta(boolChoices(), "", "true", SourceStableDiffusionCPP, ""),
	"sdconditioningcachesize":    meta(values("0", "4", "8", "16"), "", "4", SourceStableDiffusionCPP, ""),
	"sddisableprefetch":          meta(boolChoices(), "", "false", SourceStableDiffusionCPP, ""),
	"sddisablesegmentedcompute":  meta(boolChoices(), "", "false", SourceStableDiffusionCPP, ""),
	"sdsageattention":            meta(boolChoices(), "", "false", SourceStableDiffusionCPP, ""),
	"sdlinearscale":              meta(values("0", "1"), "", "0", SourceStableDiffusionCPP, ""),
	"sdattnscale":                meta(values("0", "1"), "", "0", SourceStableDiffusionCPP, ""),
	"sdloglevel":                 meta(values("debug", "verbose", "info", "warn", "error"), "", "info", SourceStableDiffusionCPP, ""),
	"sdmodelargs":                meta(values("qwen_image_2_1_prefix_cache=false", "qwen_image_zero_cond_t=true", "chroma_use_dit_mask=false"), "", "", SourceStableDiffusionCPP, ""),
	"sdextrasampleargs":          meta(values("noise_sampler=brownian_tree", "noise_sampler=iid", "uniform=true"), "", "", SourceStableDiffusionCPP, ""),
	"sdextratilingargs":          meta(values("temporal_tile_frames=4,temporal_tile_overlap=1"), "", "", SourceStableDiffusionCPP, ""),
	"sdimagepreprocess":          meta(nil, "", "", SourceStableDiffusionCPP, ""),
...
func samplingMethodChoices() []string {
	return values("euler", "euler_a", "heun", "dpm2", "dpm++2s_a", "dpm++2m", "dpm++2m_sde", "dpm++2m_sde_bt", "dpm++2mv2", "ipndm", "ipndm_v", "lcm", "ddim_trailing", "tcd", "res_multistep", "res_2s", "er_sde", "euler_cfg_pp", "euler_a_cfg_pp", "euler_ge", "lms")
}

func schedulerChoices() []string {
	return values("discrete", "karras", "exponential", "ays", "gits", "smoothstep", "sgm_uniform", "simple", "kl_optimal", "lcm", "bong_tangent", "ltx2", "logit_normal", "flux2", "flux", "beta", "llada_image")
}
