...
func routerEndpointsBeforeTheRouteTable(service *Service) []expectedRoute {
	return []expectedRoute{
		...
		{http.MethodGet, "/router/v1/site/webuis", false, service.webUI.handleSiteWebUIs},
		{http.MethodPost, "/router/v1/site/webuis/session", false, service.webUI.handleSiteWebUISession},
		{http.MethodPost, "/router/v1/site/webuis/load", false, service.webUI.handleSiteWebUILoad},
		...
		{http.MethodPost, "/router/v1/site/model-assets/export", false, service.assets.handleSiteModelAssetExport},
		{http.MethodPost, "/router/v1/site/model-files/hash", false, service.assets.handleSiteModelFileHash},
		{http.MethodPost, "/router/v1/site/model-assets/resolve", false, service.assets.handleSiteModelAssetResolve},
		{http.MethodPost, "/router/v1/site/model-assets/resolve-batch", false, service.assets.handleSiteModelAssetResolveBatch},
		{http.MethodPost, "/router/v1/site/model-assets/jobs", false, service.assets.handleSiteModelAssetCreateJob},
		{http.MethodPost, "/router/v1/site/model-assets/bind", false, service.assets.handleSiteModelAssetBinding},
		{http.MethodPost, "/router/v1/site/model-assets/candidates", false, service.assets.handleSiteModelAssetCandidates},
		{http.MethodPost, "/router/v1/site/model-assets/substitute", false, service.assets.handleSiteModelAssetSubstitution},
		{http.MethodGet, "/router/v1/site/model-assets/jobs/" + "sample-id", false, service.assets.handleSiteModelAssetJob},
		{http.MethodGet, "/router/v1/site/model-assets/" + "sample-id", false, service.assets.handleSiteModelAssetLookup},
		...
		{http.MethodPost, "/router/v1/node/site/model-assets/resolve", true, service.assets.handleNodeModelAssetResolve},
		{http.MethodPost, "/router/v1/node/site/model-assets/export", true, service.assets.handleNodeModelAssetExport},
		{http.MethodPost, "/router/v1/node/site/model-files/hash", true, service.assets.handleNodeModelFileHash},
		{http.MethodPost, "/router/v1/node/site/model-assets/jobs", true, service.assets.handleNodeModelAssetCreateJob},
		{http.MethodPost, "/router/v1/node/site/model-assets/bind", true, service.assets.handleNodeModelAssetBinding},
		{http.MethodPost, "/router/v1/node/site/model-assets/candidates", true, service.assets.handleNodeModelAssetCandidates},
		{http.MethodPost, "/router/v1/node/site/model-assets/substitute", true, service.assets.handleNodeModelAssetSubstitution},
		{http.MethodGet, "/router/v1/node/site/model-assets/jobs/" + "sample-id", true, service.assets.handleNodeModelAssetJob},
		{http.MethodPost, "/router/v1/node/assets/lookup", true, service.assets.handleNodeAssetLookup},
		{http.MethodPost, "/router/v1/node/assets/lookup-cluster", true, service.assets.handleNodeClusterAssetLookup},
		{http.MethodGet, "/router/v1/node/assets/" + "sample-id", true, service.assets.handleNodeAssetStream},
		...
		{http.MethodGet, "/router/v1/node/site/webuis", true, service.webUI.handleNodeSiteWebUIs},
		...
		{http.MethodPost, "/router/v1/node/site/webuis/load", true, service.webUI.handleNodeSiteWebUILoad},
		{http.MethodGet, nodeWebUIProxyPrefix + "sample-id", true, service.webUI.handleNodeWebUIProxy},
		{http.MethodPost, nodeWebUIProxyPrefix + "sample-id", true, service.webUI.handleNodeWebUIProxy},
		{http.MethodDelete, nodeWebUIProxyPrefix + "sample-id", true, service.webUI.handleNodeWebUIProxy},
